...
module RailsAdminNext
  module Config
    module Fields
      ...
      # association type.
      #
      # @see RailsAdminNext::Config::Fields.registry
      ...
      @@default_factory = proc do |parent, properties, fields|
        ...
        if properties.association?
          ...
          field = RailsAdminNext::Config::Fields::Types.load("#{association.polymorphic? ? :polymorphic : properties.type}_association").new(parent, properties.name, association)
        else
          field = RailsAdminNext::Config::Fields::Types.load(properties.type).new(parent, properties.name, properties)
        end
        fields << field
        field
      end
      ...
      # loads fields if their name is password. A third factory handles
      # encrypted_password columns (used by Devise and similar libs).
      #
      # @see RailsAdminNext::Config::Fields.register_factory
      # @see rails_admin_next/config/fields/factories/password.rb
      # @see rails_admin_next/config/fields/factories/encrypted_password.rb
...
require "rails_admin_next/config/fields/factories/password"
require "rails_admin_next/config/fields/factories/enum"
require "rails_admin_next/config/fields/factories/encrypted_password"
require "rails_admin_next/config/fields/factories/active_storage"
require "rails_admin_next/config/fields/factories/action_text"
require "rails_admin_next/config/fields/factories/association"
