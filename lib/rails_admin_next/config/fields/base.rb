...
require "rails_admin_next/config/groupable"
    ...
    module Fields
      class Base # rubocop:disable Metrics/ClassLength
        ...
        register_instance_option :search_operator do
          RailsAdminNext::Config.default_search_operator
        end
        ...
        #
        # @see RailsAdminNext::AbstractModel.properties
        ...
        register_instance_option :visible? do
          returned = true
          (RailsAdminNext.config.default_hidden_fields || {}).each do |section, fields|
            next unless self.section.is_a?("RailsAdminNext::Config::Sections::#{section.to_s.camelize}".constantize)
        ...
        # columns mapped (belongs_to, active_storage, etc.). First one is used for searching/sorting by default
        ...
        register_instance_option :render do
          bindings[:view].render partial: "rails_admin_next/main/#{partial}", locals: {field: self, form: bindings[:form]}
        end
        ...
        def association?
          is_a?(RailsAdminNext::Config::Fields::Association)
        end
        ...
        #
        # @see RailsAdminNext::Config::Fields::Base.register_instance_option :required?
        def optional?
          !required?
        end
        ...
        #
        # @see RailsAdminNext::Config::Fields::Base.optional
        def optional=(state)
          optional(state)
        end
        ...
        def value
          ...
          raise e.exception <<~ERROR
            #{e.message}
            If you want to use a RailsAdminNext virtual field(= a field without corresponding instance method),
