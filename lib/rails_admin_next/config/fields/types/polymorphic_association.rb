...
module RailsAdminNext
  module Config
    module Fields
      module Types
        class PolymorphicAssociation < RailsAdminNext::Config::Fields::Types::BelongsToAssociation
          ...
          register_instance_option :formatted_value do
            (o = value) && o.send(RailsAdminNext.config(o).object_label_method)
          end
          ...
          def associated_model_config
            @associated_model_config ||= association.klass.collect { |type| RailsAdminNext.config(type) }.reject(&:excluded?)
          end
