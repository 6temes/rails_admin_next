...
module RailsAdminNext
  module Config
    module Fields
      module Types
        class MultipleActiveStorage < RailsAdminNext::Config::Fields::Types::MultipleFileUpload
          RailsAdminNext::Config::Fields::Types.register(self)

          class ActiveStorageAttachment < RailsAdminNext::Config::Fields::Types::MultipleFileUpload::AbstractAttachment
