    ...
    module Actions
      class << self
        ...
        def add_action(key, parent_class, parent, &)
          a = "RailsAdminNext::Config::Actions::#{parent_class.to_s.camelize}".constantize.new
          a.instance_eval(%(
            #{parent} true
            def key
              :#{key}
...
require "rails_admin_next/config/actions/base"
require "rails_admin_next/config/actions/dashboard"
require "rails_admin_next/config/actions/index"
require "rails_admin_next/config/actions/show"
require "rails_admin_next/config/actions/show_in_app"
require "rails_admin_next/config/actions/history_show"
require "rails_admin_next/config/actions/history_index"
require "rails_admin_next/config/actions/new"
require "rails_admin_next/config/actions/edit"
require "rails_admin_next/config/actions/export"
require "rails_admin_next/config/actions/delete"
require "rails_admin_next/config/actions/bulk_delete"
