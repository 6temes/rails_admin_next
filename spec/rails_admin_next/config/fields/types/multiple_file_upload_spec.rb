...
RSpec.describe RailsAdminNext::Config::Fields::Types::MultipleFileUpload do
  ...
  describe "#allowed_methods" do
    it "includes delete_method" do
      ...
      expect(RailsAdminNext.config(FieldTest).field(:active_storage_assets).with(object: FieldTest.new).allowed_methods.collect(&:to_s)).to eq %w[active_storage_assets remove_active_storage_assets]
    end
  end
