...
RSpec.describe RailsAdminNext::Config::Fields::Types::Json do
  let(:field) { RailsAdminNext.config(FieldTest).fields.detect { |f| f.name == :json_field } }
  ...
  describe "aliasing" do
    ...
    it "allows use of :jsonb fieldtype" do
      expect(field.class).to eq RailsAdminNext::Config::Fields::Types::Json
    end
  end
