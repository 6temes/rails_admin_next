...
RSpec.describe RailsAdminNext::Config::Fields::Types::Timestamp, active_record: true do
  ...
  describe "#parse_input" do
    before :each do
      ...
      @field = RailsAdminNext.config(FieldTest).fields.detect { |f| f.name == :timestamp_field }
    end
